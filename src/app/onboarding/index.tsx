...
function AvatarIllustration({ gender }: { gender: OnboardingGender }) {
  ...
  return (
    <Svg width={90} height={90} viewBox="0 0 90 90" accessible={false}>
      ...
      <Path
        d={
          isGirl ? "M28 72 C31 54 59 54 62 72 Z" : "M26 74 C30 52 60 52 64 74 Z"
        }
      ...
      <Path
        d={
          isGirl
            ? "M29 35 C30 18 60 18 61 35 C58 25 52 22 45 22 C38 22 32 25 29 35 Z"
            : "M28 36 C29 21 61 21 62 36 C59 27 53 24 45 24 C37 24 31 27 28 36 Z"
        }
        fill={hair}
      />
...
export default function OnboardingIntroScreen() {
  ...
  const [selectedGender, setSelectedGender] = useState<OnboardingGender | null>(
            ...
            >
              <Pressable
                ...
                style={[
                  styles.avatarCard,
                  selectedGender === "girl"
                    ? styles.avatarCardSelected
                    : styles.avatarCardUnselected,
                ]}
              >
